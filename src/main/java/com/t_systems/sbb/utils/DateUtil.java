package com.t_systems.sbb.utils;
...
public class DateUtil {
    ...
    public static Date convertScheduleTimeToDate(String stringDate){
        return convertStringToDate(stringDate, TIME_PATTERN);
    }

    public static String convertScheduleTimeToString(Date date){
